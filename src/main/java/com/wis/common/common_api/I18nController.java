...
public class I18nController {
    ...
    public ResponseEntity<String> importI18n(@RequestParam("file") MultipartFile file) {
        try {
            ...
            throw new TranslateException(HttpStatus.INTERNAL_SERVER_ERROR, TranslateCommon.I18N_IMPORT_ERROR, List.of(e.getMessage()));
    ...
    public void exportDynamicKeys(HttpServletResponse response) {
        try {
            ...
            throw new TranslateException(HttpStatus.INTERNAL_SERVER_ERROR, TranslateCommon.I18N_EXPORT_ERROR, List.of(e.getMessage()));
        }
    }
}

package com.wis.main.exception.service;
...
@Log4j2
public class GlobalExceptionService extends CoreBean {
    private final TranslateExceptionService translateExceptionService;
    ...
    public ResponseEntity<?> handleServiceException(ServiceException ex, HttpServletRequest request) {
        ...
        errorResponse = translateExceptionService.execute(new Payload(),errorResponse);
